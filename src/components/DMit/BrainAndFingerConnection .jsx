    ...
    <div className=" p-8 ">
      ...
      <div className="flex flex-col lg:flex-row items-center">
        ...
        <div className="flex-1 md:text-[16px]">
          ...
          <p className="mb-4">
            Medical experts and scientists have discovered that the distribution of brain cells in different parts of the brain can be understood through the DMIT test. This helps reveal a persons multiple intelligences, innate potential capabilities, and personality.
          </p>
