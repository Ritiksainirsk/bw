...
export default function PartnersVideoCard() {
  ...
  return (
    <div>
      <PartnerSection selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory}/>
    </div>
  );
}
...
<div className="py-16 text-center w-full">
    ...
    <AnimatedSection>
 {    selectedCategory ==1 && <div className="flex flex-wrap md:grid md:grid-cols-3 gap-6">
        <PartnerCard
